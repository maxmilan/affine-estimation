...
class A11(UnivariateModel):
  ...
  def c2(self, x, x_0, θ):
    return 1 / (576 * x**2 * x_0**2) * (9 * (256 * θ[3]**4 - 512 * θ[3]**3 + 224 * θ[3]**2 + 32 * θ[3] - 15) + 6 * x * x_0 * (θ[0] - θ[2])**2 * (x**2 + (24 * θ[3]) / (θ[0] - θ[2])) * (16 * θ[3]**2 - 16 * θ[3] + 3) + x**2 * x_0**2 * (θ[0] - θ[2])**2 * (672 * θ[3]**2 - 48 * θ[3] * (2 - (θ[0] - θ[2]) * x**2) - 6 + (θ[0] - θ[2])**2 * x**4) + 2 * x * x_0**3 * (θ[0] - θ[2])**2 * (48 * θ[3]**2 - 24 * θ[3] * (2 - (θ[0] - θ[2]) * x**2) + 9 + (θ[0] - θ[2])**2 * x**4) + 3 * x**2 * x_0**4 * (θ[0] - θ[2])**4 * (x**2 + (16 * θ[3]) / (θ[0] - θ[2])) + 2 * x**3 * x_0**5 * (θ[0] - θ[2])**4 + x**2 * x_0**6 * (θ[0] - θ[2])**4)
  ...
  def print_params(self, θ):
    print("| b_11 = " + str(θ[0]) + ", δ_1 = " + str(θ[1]) + ", λ_1 = " + str(θ[2]) + ", a_1 = " + str(θ[3]) + " |")
