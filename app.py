...
# a01_true = minimize(univariate_likelihood, theta0, args=(model01, y_s, "true",), method='nelder-mead', options= { 'disp': False, 'maxiter': 1000 })
# end_time = time.time()
...
# start_time = time.time()
# a01_euler = minimize(univariate_likelihood, theta0, args=(model01, y_s, "euler",), method='nelder-mead', options= { 'disp': False, 'maxiter': 1000 })
# end_time = time.time()
...
# start_time = time.time()
# a01_qml = minimize(univariate_likelihood, theta0, args=(model01, y_s, "qml",), method='nelder-mead', options= { 'disp': False, 'maxiter': 1000 })
# end_time = time.time()
...
# start_time = time.time()
# a01_approx_1 = minimize(univariate_likelihood, theta0, args=(model01, y_s, 1,), method='nelder-mead', options= { 'disp': False, 'maxiter': 1000 })
# end_time = time.time()
...
# start_time = time.time()
# a01_approx_2 = minimize(univariate_likelihood, theta0, args=(model01, y_s, 2,), method='nelder-mead', options= { 'disp': False, 'maxiter': 1000 })
# end_time = time.time()
